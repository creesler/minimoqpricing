...
app.use('/api/scrape-labels', scrapeLabels); // ✅ USING the router

const labeledCombinationsRoute = require('./routes/labeledCombinations');
app.use('/api/labeled-combinations', labeledCombinationsRoute); // ✅ NEW: for per-product combos
