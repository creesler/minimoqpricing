...
async function scrapeGroups(url) {
  ...
  // 🐛 DEBUG
  console.log('\n📦 fullColorFields:', fullColorFields.length);
  console.log('📦 blackFields:', blackFields.length);
