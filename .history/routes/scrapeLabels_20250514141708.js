...
router.get('/', async (req, res) => {
  ...
  try {
    ...
    // ✅ CHECK: Is the page ready?
    // const isReady = doc.querySelector('body[data-ready="true"]');
    // if (!isReady) {
    //   return res.status(503).json({
    //     success: false,
    //     error: 'Page not fully loaded. Missing data-ready flag. Make sure your site includes it after DOMContentLoaded.'
    //   });
    // }
